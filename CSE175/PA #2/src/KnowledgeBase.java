    ...
    public boolean readFacts() {
		try {
		    ...
		    if (factFile.exists() && factFile.canRead()) {
				...
				InputStreamReader factISReader = new InputStreamReader(factFileIn);
				BufferedReader factBufferedReader = new BufferedReader(factISReader);
				Scanner factScanner = new Scanner(factBufferedReader);
    ...
    public boolean readRules() {
		try {
		    ...
		    if (ruleFile.exists() && ruleFile.canRead()) {
				...
				InputStreamReader ruleISReader = new InputStreamReader(ruleFileIn);
				BufferedReader ruleBufferedReader = new BufferedReader(ruleISReader);
				Scanner ruleScanner = new Scanner(ruleBufferedReader);
